...
import { menuHelp } from "../components/menus/helpMenu.ts";
...
export default {
    ...
    async execute(interaction) {
        if (interaction.isAnySelectMenu() && interaction.customId === 'menuHelp') {
            try {
                if (!await commandLog("menuButtonHandle", interaction, 1))
                    return;
                ...
                const commandsDescription = {
                    info: `</help:1285287069676994605> - ${localinfo.info[0]} \n` +
                    ...
                    admin: `</language:1292081237837611079> - ${localinfo.admin[0]} \n` +
                    ...
                    moder: `</clear:1285287069676994609> - ${localinfo.moder[0]} \n` +
                        `</post:1302340870892163093> - ${localinfo.moder[1]} \n`,
                    economy: lang.indev,
                    util: `</calc:1285287069756690488> - ${localinfo.util[0]} \n` +
                        `</translate:1285287069756690490> - ${localinfo.util[1]} \n` +
                        `</weather:1285287069756690491> - ${localinfo.util[2]} \n`,
                    games: `</anime:1294302199869997197> - ${localinfo.games[0]} \n` +
                        `\`+aura\` - ${localinfo.games[1]} \n` +
                        `\`-aura\` - ${localinfo.games[2]}`,
                    fun: `</ai-animal:1365688051745165423> - ${localinfo.fun[6]} \n` +
