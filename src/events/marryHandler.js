...
import { removeRelation, setRelation, getRelation } from '../repo/relationRepository.ts';
...
export default {
    ...
    async execute(interaction) {
        try {
            ...
            if (!marryActions.includes(customId))
                return;
            if (!await commandLog("marryHandle", interaction, 1))
                return;
