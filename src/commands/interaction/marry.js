        ...
        try {
            ...
            if (mentionUser) {
                ...
                if (mentionUserBot || SelfMention || isRelation || isMentionUserRelation) {
                    let relationError;
                    if (mentionUserBot)
                        relationError = lang.error.dontbot;
                    if (isMentionUserRelation)
                        relationError = local.wasMarry;
                    if (SelfMention)
                        relationError = lang.error.dontyourself;
                    if (isRelation)
                        relationError = local.youWasMarry;
