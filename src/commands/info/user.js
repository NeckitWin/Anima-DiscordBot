...
import { getUserWallet } from "../../repo/walletRepository.ts";
export default {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (!member)
                return await interaction.reply({ content: lang.error.usernotfound, ephemeral: true });
            ...
            if (nitro || banner)
                bage += ` <a:nitro_gif:1295015596710432859> <:nitro_subscriber:1295015733226377256>`;
            if (user.bot)
                bage = `<a:code:1297250463644782643>`;
