    ...
    async execute(interaction) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setImage(botBanner)
                .addFields({ name: `📅 ${local.create}`, value: `╰ **\`${botCreated}\`**`, inline: false }, { name: `❤️‍🔥 ${local.use}`, value: `╰ **\`${serversCount}\`** ${local.servers}`, inline: false }, { name: `👥 ${local.help}`, value: `╰ **\`${usersCount}\`** ${local.users}`, inline: false })
